    ...
    pains: [
      {
        ...
        p: 'Platforms als Treatwell rekenen tot 35% commissie op de eerste boeking van een nieuwe klant. Word je in Google Maps en in AI-antwoorden direct gevonden, dan boekt diezelfde klant bij jou zonder tussenpartij.',
      },
      {
    ...
    pains: [
      {
        ...
        p: 'Voor de klant die zoekt, lijk je online op elke andere aanbieder. Een compleet profiel, de juiste categorieen en reviews zetten jouw niveau neer.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Met een compleet Google Bedrijfsprofiel op je winstgevende behandeling, meer en recentere reviews dan de concurrent, en aanwezigheid op Apple Maps en in AI-antwoorden. Dat samen bepaalt bij wie de klant terechtkomt.',
      },
      {
        q: 'Hoe lang duurt het voor ik hoger sta?',
        a: 'De eerste fundament-verbeteringen zetten we in de eerste weken neer. Ranking en reviews bouwen op over 60 tot 90 dagen. We meten de nulmeting bij de start en laten maandelijks zien hoe het beweegt.',
      },
    ],
  },
  {
    ...
    pains: [
      {
        ...
        p: 'Jouw HBO-opleiding en beschermde titel zie je niet terug in de zoekresultaten. De juiste positionering en categorieen maken het verschil zichtbaar.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Door je profiel in te richten op je paramedische specialisatie en behandelingen, de juiste Google-categorie te kiezen, en reviews te verzamelen die je vakmanschap tonen. Zo zien zoekers en AI-tools dat je meer bent dan een salon.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        ...
        a: 'Met een compleet Google Bedrijfsprofiel vol foto\'s van je werk en echte reviews. Dat overtuigt zonder verkooppraat, en het is precies wat een AI-tool of zoeker gebruikt om jou aan te bevelen.',
      },
    ],
  },
  {
    ...
    pains: [
      ...
      },
      {
        ...
        p: 'De vraag naar herstel en wellness groeit, maar als je niet bovenaan staat als iemand lokaal zoekt, gaat die interesse naar een ander. Wij zetten je op de kaart, ook in AI-antwoorden.',
      },
    ],
    faq: [
      {
