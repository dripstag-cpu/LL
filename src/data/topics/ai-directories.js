...
export const topics = [
  ...
  },
  {
    ...
    sections: [
      {
        ...
        p: 'Bij zoekmachine-optimalisatie strijd je om een positie in een lijst, en de gebruiker kiest zelf uit tien resultaten. Bij een answer engine krijgt de gebruiker vaak maar een handjevol namen te horen, of soms maar een paar. Er is dus minder ruimte, en buiten die selectie vallen betekent onzichtbaar zijn. AEO is de discipline om binnen die kortere lijst terecht te komen, en dat vraagt vooral om duidelijkheid en consistentie in plaats van trucs.',
      },
      {
    ...
    faq: [
      {
        q: 'Moet ik SEO laten vallen en overstappen op AEO?',
        a: 'Nee. De basis is grotendeels dezelfde, en Google Maps blijft voor lokale keuzes voorlopig het belangrijkste kanaal. AEO is een aanvulling die dezelfde fundamenten hergebruikt, niet een vervanging. Je investeert een keer in een compleet en consistent profiel en plukt daar op meerdere kanalen tegelijk de vruchten van.',
      },
      {
    ...
    sections: [
      {
        ...
        p: 'Open ChatGPT, Perplexity en Gemini en typ een vraag in gewone taal, bijvoorbeeld naar een goede aanbieder van jouw behandeling in jouw stad of buurt. Gebruik niet je eigen bedrijfsnaam, want dan stuur je het antwoord. Je wil weten of je spontaan genoemd wordt bij een neutrale vraag, precies zoals een nieuwe klant hem zou intypen. Varieer de formulering een paar keer, want kleine verschillen kunnen andere antwoorden opleveren.',
      },
      {
        h: 'Let op of je genoemd wordt en hoe je omschreven wordt',
        p: 'Kijk niet alleen of je naam valt, maar ook wat er over je gezegd wordt. Klopt de informatie, worden je behandelingen goed benoemd, staat er niets verouderds in? Soms word je wel genoemd maar met oude openingstijden of een verkeerde omschrijving, en dat is net zo goed een probleem om op te lossen. Noteer ook welke concurrenten wel bovenaan het antwoord staan, want dat laat zien wie op dit moment de duidelijkste online aanwezigheid heeft.',
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        ...
        p: 'Bing Places biedt de optie om je gegevens rechtstreeks vanuit je Google Bedrijfsprofiel te importeren, wat veel handmatig werk scheelt. Heb je nog geen Google-profiel of wil je alles apart invullen, dan kun je ook van nul beginnen. Kies importeren als je Google-profiel netjes en actueel is, want dan neem je die kwaliteit in een keer mee. Controleer daarna altijd of alles klopt, want een import is een startpunt, geen eindpunt.',
      },
      {
    ...
    faq: [
      {
        q: 'Heb ik een Microsoft-account nodig?',
        a: 'Ja, je meldt je aan met een Microsoft-account, dat is gratis aan te maken als je er nog geen hebt. Daarna beheer je je profiel vanuit het Bing Places-dashboard. Bewaar de inloggegevens goed, want je hebt ze nodig om later openingstijden of behandelingen bij te werken.',
      },
    ],
  },
  {
    ...
    lead:
      'Iedereen met een iPhone gebruikt standaard Apple Maps, en toch staan veel klinieken en salons daar niet of met verouderde gegevens. Via Apple Business Connect claim en beheer je gratis hoe je bedrijf op Apple Maps verschijnt. Voor een doelgroep met veel iPhone-gebruikers is dat een kanaal dat je niet wil overslaan.',
    sections: [
      {
        h: 'Waarom Apple Maps apart aandacht verdient',
        p: 'Apple Maps trekt zijn informatie niet uit Google, het is een los ecosysteem met eigen gegevens. Sta je goed op Google maar heb je Apple nooit geclaimd, dan kan je vermelding daar onvolledig of ronduit fout zijn. Voor iPhone-gebruikers die de kaart openen om iets in de buurt te zoeken, ben je dan onzichtbaar of onbetrouwbaar. Een geclaimd en compleet Apple-profiel dicht dat gat.',
      },
      {
        h: 'Zo claim en vul je je profiel',
        p: 'Je maakt een account aan op Apple Business Connect met een Apple-account, zoekt je bedrijf op en claimt het, of voegt het toe als het er nog niet is. Apple verifieert vervolgens dat jij de eigenaar bent. Daarna vul je je bedrijfsnaam, adres, telefoonnummer, openingstijden, behandelingen en foto\'s in. Net als bij de andere platforms geldt: compleet en actueel invullen is het halve werk, een lege plek helpt niemand.',
      },
      {
    ...
    faq: [
      {
        q: 'Heb ik zelf een iPhone nodig om dit te regelen?',
        a: 'Nee, je beheert Apple Business Connect gewoon via een webbrowser op je computer, je hebt alleen een Apple-account nodig. Dat account is gratis aan te maken. Het beheren van je vermelding doe je verder volledig online, los van welk apparaat je zelf gebruikt.',
      },
    ],
  },
  {
    ...
    lead:
      'NAP staat voor Naam, Adres en Telefoonnummer. NAP-consistentie betekent dat die drie gegevens overal online precies hetzelfde staan: op Google, Bing, Apple, in directories en op je eigen website. Klinkt saai, maar het is een van de stilste redenen waarom de ene kliniek beter vindbaar is dan de andere.',
    sections: [
      {
      ...
      },
      {
        ...
        p: 'Verschillen sluipen er ongemerkt in: een oud adres na een verhuizing dat ergens blijft staan, een 06-nummer op de ene site en een vast nummer op de andere, of je bedrijfsnaam met en zonder de plaatsnaam erachter. Ook oude vermeldingen in directories die je jaren geleden hebt achtergelaten, spelen mee. Elk verschil is een klein signaal dat je verhaal niet helemaal klopt. Bij elkaar opgeteld ondermijnen ze je betrouwbaarheid over alle kanalen tegelijk.',
      },
      {
    ...
    faq: [
      {
        q: 'Telt een klein verschil zoals een spatie of afkorting echt mee?',
        a: 'Voor een mens niet, maar systemen lezen letterlijk. Consequent dezelfde schrijfwijze aanhouden voorkomt onnodige twijfel bij de tools die je gegevens uitlezen. Het gaat er niet om dat een enkele afwijking je meteen onvindbaar maakt, maar dat veel kleine verschillen samen je beeld troebel maken.',
      },
      {
        q: 'Hoe vind ik alle plekken waar mijn gegevens staan?',
        a: 'Begin bij de grote platforms Google, Bing en Apple, en zoek daarnaast je bedrijfsnaam en oude adressen op om verouderde directory-vermeldingen op te sporen. Een gestructureerde controle brengt in kaart waar je overal staat en waar de gegevens afwijken, zodat je gericht kunt opschonen.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        q: 'Moet ik ook op sociale media staan om vindbaar te zijn?',
        a: 'Sociale media helpen bij vertrouwen en herhaalbezoek, maar ze zijn zelden de plek waar een nieuwe klant je voor het eerst vindt via een zoekopdracht. Voor pure vindbaarheid wegen je Google Bedrijfsprofiel, Apple, Bing en je website zwaarder. Zet je energie eerst daar, en gebruik sociale media als aanvulling, niet als vervanging.',
      },
      {
        q: 'Hoe weet ik welke platforms voor mijn niche het belangrijkst zijn?',
        a: 'Dat verschilt per behandeling en per stad, afhankelijk van waar jouw type klant zoekt. Een vindbaarheids-check laat zien op welke platforms je nu staat, waar je gegevens afwijken en waar je concurrenten wel en niet aanwezig zijn. Zo bepaal je gericht waar je aandacht het meeste oplevert.',
      },
    ],
  },
];
